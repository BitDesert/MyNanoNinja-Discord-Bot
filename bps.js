...
async function getBlocksPerSecond(dimension){
  var stats = await axios.get('https://node-proxy.nanoticker.info/api/v1/data?chart=repstats_v21_local.tps_median_pr&format=json&points=320&group=average&after=-3600&options=flip|jsonwrap&dimension='+dimension);
